...
const About = () => {
  ...
  return <div className=" h-full w-full px-6 flex flex-col items-center gap-10">
    {/* text div */}
    <div className=" md:w-2/3 flex flex-col justify-start gap-8">
      ...
      <div className=" flex justify-between px-10">
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi, accusantium!</p>
      </div>
